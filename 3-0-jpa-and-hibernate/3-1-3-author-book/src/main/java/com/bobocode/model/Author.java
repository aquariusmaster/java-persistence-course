...
public class Author {
    ...
    @JoinTable(
            name = "author_book",
            joinColumns = @JoinColumn(name = "author_id", foreignKey = @ForeignKey(name = "author_id")),
            inverseJoinColumns = @JoinColumn(name = "book_id", foreignKey = @ForeignKey(name = "book_id"))
    )
